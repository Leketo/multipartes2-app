...
public class ConsultaVisitasWebViewActivity extends ActionBarActivity  {

    public static final String TAG = ConsultaVisitasWebViewActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_visitas_webview);
        ...
        getSupportActionBar().setTitle("Mis Visitas");


        String downloadPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) +  "";


        webViewPdf = (PDFView) findViewById(R.id.webView2);

        Uri url = Uri.fromFile(new File(downloadPath+"/visitas_multipartes.pdf"));
