...
public class ConsultaPedidosWebViewActivity extends ActionBarActivity  {

    public static final String TAG = ConsultaPedidosWebViewActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_pedidos_webview);
        ...
        webViewPdf = (PDFView) findViewById(R.id.webView3);

        Uri url = Uri.fromFile(new File(downloadPath+"/pedidos_multipartes.pdf"));
