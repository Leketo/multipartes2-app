...
public class ConsultaEntregasActivity extends ActionBarActivity implements View.OnClickListener {

    public static final String TAG = ConsultaEntregasActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_entregas);
        ...
        getSupportActionBar().setTitle("Consulta Entregas");
        ...
        consultarBtn = (Button) findViewById(R.id.consultas_entregas_btn);
        desdeEditText = (EditText) findViewById(R.id.consultas_entregas_desde);
        hastaEditText = (EditText) findViewById(R.id.consultas_entregas_hasta);

        desdeBtn = (ImageButton) findViewById(R.id.consultas_entregas_desde_calendar_btn);
        hastaBtn = (ImageButton) findViewById(R.id.consultas_entregas_hasta_calendar_btn);
        ...
        consultarBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (desdeEditText.getText().toString().equals("") || hastaEditText.getText().toString().equals("") ){
                    String[] buttons = {"Ok"};
                    AppUtils.show(null, "Seleccione el rango de fechas Desde/Hasta", buttons, ConsultaEntregasActivity.this, false, dialogOnclicListener);
                    return;
                }
                ...
                //crea el archivo pdf a descargar, para luego ser leido
                File file = new File(folder, "entregas_multipartes.pdf");
                try {
                    file.createNewFile();
                ...
                String url = Comm.URL + "api/report/entregas?from="+desde+"&to="+hasta+"&clientId=0&userId="+session.getUserId()+"&format=pdf";
                Log.d(TAG, url);

                DownloaderPdf.DownloadFile(url, file);
                //DownloaderPdf.DownloadFile("http://www.pdf995.com/samples/pdf.pdf", file);

                Intent intent = new Intent(ConsultaEntregasActivity.this, ConsultaEntregasWebViewActivity.class);
