...
public class ConsultaCobrosActivity extends ActionBarActivity implements View.OnClickListener {

    public static final String TAG = ConsultaCobrosActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_cobros);
        ...
        getSupportActionBar().setTitle("Consulta Cobros");
        ...
        consultarBtn = (Button) findViewById(R.id.consultas_cobros_btn);
        desdeEditText = (EditText) findViewById(R.id.consultas_cobros_desde);
        hastaEditText = (EditText) findViewById(R.id.consultas_cobros_hasta);

        desdeBtn = (ImageButton) findViewById(R.id.consultas_cobros_desde_calendar_btn);
        hastaBtn = (ImageButton) findViewById(R.id.consultas_cobros_hasta_calendar_btn);
        ...
        consultarBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (desdeEditText.getText().toString().equals("") || hastaEditText.getText().toString().equals("") ){
                    String[] buttons = {"Ok"};
                    AppUtils.show(null, "Seleccione el rango de fechas Desde/Hasta", buttons, ConsultaCobrosActivity.this, false, dialogOnclicListener);
                    return;
                }
                ...
                File file = new File(folder, "cobros_multipartes.pdf");
                try {
                    file.createNewFile();
                ...
                String url = Comm.URL + "api/report/cobros?from="+desde+"&to="+hasta+"&clientId=0&userId="+session.getUserId()+"&format=pdf";
                Log.d(TAG, url);

                DownloaderPdf.DownloadFile(url, file);
                //DownloaderPdf.DownloadFile("http://www.pdf995.com/samples/pdf.pdf", file);

                Intent intent = new Intent(ConsultaCobrosActivity.this, ConsultaCobrosWebViewActivity.class);
