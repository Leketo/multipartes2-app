...
public class ConsultaPedidosActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    public static final String TAG = ConsultaPedidosActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Consulta Pedidos");
        ...
        consultarBtn = (Button) findViewById(R.id.consultas_pedidos_btn);
        desdeEditText = (EditText) findViewById(R.id.consultas_pedidos_desde);
        hastaEditText = (EditText) findViewById(R.id.consultas_pedidos_hasta);

        desdeBtn = (ImageButton) findViewById(R.id.consultas_pedidos_desde_calendar_btn);
        hastaBtn = (ImageButton) findViewById(R.id.consultas_pedidos_hasta_calendar_btn);
        ...
        consultarBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (desdeEditText.getText().toString().equals("") || hastaEditText.getText().toString().equals("") ){
                    String[] buttons = {"Ok"};
                    AppUtils.show(null, "Seleccione el rango de fechas Desde/Hasta", buttons, ConsultaPedidosActivity.this, false, dialogOnclicListener);
                    return;
                }
                ...
                File file = new File(folder, "pedidos_multipartes.pdf");
                try {
                    file.createNewFile();
                ...
                Intent intent = new Intent(ConsultaPedidosActivity.this, ConsultaPedidosWebViewActivity.class);
